...
ownerID = int("5089141183") #ايدي الادمن 
api_hash = "ffe7d862b0a31893682a62bbc0654ced" #ايبي هاش 
api_id = 26957529 #ايبي ايدي
token = "7319206753:AAFSDlHNq1z22lslmr3Yf-MZZN6x8usDU6A" #توكن البوت


bot = Client(
  'bot'+token.split(":")[0],
  26957529, #ايبي ايدي
 'ffe7d862b0a31893682a62bbc0654ced', #ايبي هاش
